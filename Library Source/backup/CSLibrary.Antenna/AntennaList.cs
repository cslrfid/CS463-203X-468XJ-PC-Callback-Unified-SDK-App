...
namespace CSLibrary
{
    ...
    //using CSLibrary.Collections.Generic;
    /// <summary>
    /// AntennaList
    /// </summary>
#if NETCFDESIGNTIME
...
#endif
    //public class AntennaList:SynchronisedObservableCollection<Antenna>
    public class AntennaList : List<Antenna>
    {
        ...
        public void Copy(IEnumerable<Antenna> from)
        {
            ...
            {
                this.Add(new Antenna(antenna, port++));
            }
        }
#else
        /// <summary>
        ...
        )
        {
            ...
            for (UInt32 port = 0; port < 16; ++port)
            {
                ...
                {
                    Debug.WriteLine("Error while reading antenna information");
