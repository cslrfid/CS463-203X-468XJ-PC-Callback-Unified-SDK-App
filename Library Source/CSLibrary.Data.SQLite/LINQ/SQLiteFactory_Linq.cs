...
namespace CSLibrary.Data.SQLite
{
  using System;
  ...
  public sealed partial class SQLiteFactory : IServiceProvider
  {
    ...
    private object GetSQLiteProviderServicesInstance()
    {
      ...
      {
        Type type = Type.GetType("CSLibrary.Data.SQLite.SQLiteProviderServices, CSLibrary.Data.SQLite.Linq, Version=2.0.38.0, Culture=neutral, PublicKeyToken=db937bc2d44ff139", false);
        if (type != null)
        {
