...
namespace CS203_CALLBACK_API_DEMO
{
    ...
    public class appSettings
    {
        ...
        private bool m_lbtScan = false;

        public bool FreqAgile = false;

        public UInt16 m_cfg_ReversePowerThreshold = 240;
        ...
        private int m_rflna_high_comp_norm = 1;
        private int m_rflna_gain_norm = 0;
        private int m_iflna_gain_norm = 0;
        private int m_ifagc_gain_norm = 1;
        ...
        public UInt16 Cfg_ReversePowerThreshold
        {
            get { return m_cfg_ReversePowerThreshold; }
            set { m_cfg_ReversePowerThreshold = value; }
        }
        ...
        public int rflna_high_comp_norm
        {
            get { return m_rflna_high_comp_norm; }
            set { m_rflna_high_comp_norm = value; }
        }

        public int rflna_gain_norm
        {
            get { return m_rflna_gain_norm; }
            set { m_rflna_gain_norm = value; }
        }

        public int iflna_gain_norm
        {
            get { return m_iflna_gain_norm; }
            set { m_iflna_gain_norm = value; }
        }
        
        public int ifagc_gain_norm
        {
            get { return m_ifagc_gain_norm; }
            set { m_ifagc_gain_norm = value; }
        }
        
        public uint [] TestSetupMaxPower = new uint[6] {290, 300, 300, 300, 300, 290};
